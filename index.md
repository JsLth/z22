...
corresponding data files are very large and hard to work with.
[z22](https://github.com/jslth/z22/) aims to quickly and efficiently
retrieve German census grid data. The package also eases comparisons to
grid data from the census 2011 by establishing a standardized feature
format.
